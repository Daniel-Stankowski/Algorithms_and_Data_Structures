...
public class QuickSortEfficiencyTests {
    ...
    public void setUp() {
        ...
        randomEfficiencyFile = new File(
                "src\\test\\java\\pl\\edu\\pw\\ee\\sortingEfficiency\\quickSortEfficiency\\randomEfficiency.txt");
        optimisticEfiiciencyFile = new File(
                "src\\test\\java\\pl\\edu\\pw\\ee\\sortingEfficiency\\quickSortEfficiency\\optimisticEfficiency.txt");
        pesimisticEfficiencyFile = new File(
                "src\\test\\java\\pl\\edu\\pw\\ee\\sortingEfficiency\\quickSortEfficiency\\pesimisticEfficiency.txt");
    }
    ...
    public void optimisticArrayEfficiencyTest() {
        ...
        for (int i = 1000; i <= maxNumberOfValues; i += 500) {
            ...
            for (int j = 0; j < i; j++) {
                optimisticEfficiencyArray[j] = random.nextDouble();
            }
            startPoint = System.nanoTime();
