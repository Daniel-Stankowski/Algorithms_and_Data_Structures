...
public class SelectionSortEfficiencyTests {
    ...
    public void setUp() {
        ...
        randomEfficiencyFile = new File(
                "src\\test\\java\\pl\\edu\\pw\\ee\\sortingEfficiency\\selectionSortEfficiency\\randomEfficiency.txt");
        optimisticEfiiciencyFile = new File(
                "src\\test\\java\\pl\\edu\\pw\\ee\\sortingEfficiency\\selectionSortEfficiency\\optimisticEfficiency.txt");
        pesimisticEfficiencyFile = new File(
                "src\\test\\java\\pl\\edu\\pw\\ee\\sortingEfficiency\\selectionSortEfficiency\\pesimisticEfficiency.txt");
    }
    ...
    public void optimisticArrayEfficiencyTest() {
        ...
        for (int i = 1000; i <= maxNumberOfValues; i += 500) {
            ...
            for (int j = 0; j < i; j++) {
                optimisticEfficiencyArray[j] = j + random.nextDouble();
            }
            startPoint = System.nanoTime();
